...
plt.xlim(0, 130)
#plt.ylim(0, 130)
plt.xlabel('Superoxide demand from nucleus')
plt.ylabel('Superoxide demand overall')
plt.title("Superoxide analysis")
#plt.savefig('/Users/subasrees/Desktop/RSmodule/September 24/Sep 16, 2024/Upload_Final/September 28/New Folder/Plant RS/RS_demand/o2s_rs_n.pdf')
plt.show()
