...
#core_model.add_reactions([reaction])
## H2O2
reaction = Reaction('H2O2_p_demand_1')
...
print(reaction.reaction) 
##
reaction = Reaction('H2O2_p_demand_2')
reaction.name = 'HYDROGEN PEROXIDE plastid-nucleus demand'
reaction.subsystem = 'RS demand'
reaction.lower_bound =0.  # This is the default
reaction.upper_bound = 1000.  # This is the default
reaction.add_metabolites({core_model.metabolites.get_by_id('HYDROGEN_PEROXIDE_p'): -1.0,core_model.metabolites.get_by_id('HYDROGEN_PEROXIDE_n'): 1.0})
core_model.add_reactions([reaction])
print(reaction.reaction) 
##
reaction = Reaction('H2O2_c_demand')
reaction.name = 'HYDROGEN PEROXIDE cytosol-nucleus demand'
reaction.subsystem = 'RS demand'
reaction.lower_bound =0.  # This is the default
reaction.upper_bound = 1000.  # This is the default
reaction.add_metabolites({core_model.metabolites.get_by_id('HYDROGEN_PEROXIDE_c'): -1.0,core_model.metabolites.get_by_id('HYDROGEN_PEROXIDE_n'): 1.0})
core_model.add_reactions([reaction])
print(reaction.reaction) 
## H2O2
...
reaction.lower_bound =0.  # This is the default
reaction.upper_bound = 1000.  # This is the default
reaction.add_metabolites({core_model.metabolites.get_by_id('HYDROGEN_PEROXIDE_g'): -1.0,core_model.metabolites.get_by_id('HYDROGEN_PEROXIDE_c'): 1.0})
#core_model.add_reactions([reaction])
#print(reaction.reaction) 
##
reaction = Reaction('H2O2_m_demand_1')
...
core_model.add_reactions([reaction])
##
reaction = Reaction('H2O2_m_demand_2')
reaction.name = 'HYDROGEN PEROXIDE mitochondrial-nucleus demand'
reaction.subsystem = 'RS demand'
reaction.lower_bound =0.  # This is the default
reaction.upper_bound = 1000.  # This is the default
reaction.add_metabolites({core_model.metabolites.get_by_id('HYDROGEN_PEROXIDE_m'): -1.0,core_model.metabolites.get_by_id('HYDROGEN_PEROXIDE_n'): 1.0})
print(reaction.reaction) 
core_model.add_reactions([reaction])
##
reaction = Reaction('H2O2_x_demand')
reaction.name = 'HYDROGEN PEROXIDE peroxisomal-nucleus demand'
reaction.subsystem = 'RS demand'
reaction.lower_bound =0.  # This is the default
reaction.upper_bound = 1000.  # This is the default
reaction.add_metabolites({core_model.metabolites.get_by_id('HYDROGEN_PEROXIDE_x'): -1.0,core_model.metabolites.get_by_id('HYDROGEN_PEROXIDE_n'): 1.0})
print(reaction.reaction) 
core_model.add_reactions([reaction])
##
...
reaction.lower_bound =0.  # This is the default
reaction.upper_bound = 1000.  # This is the default
reaction.add_metabolites({core_model.metabolites.get_by_id ('HYDROGEN_PEROXIDE_e'): -1.0,core_model.metabolites.get_by_id('HYDROGEN_PEROXIDE_c'): 1.0})
#print(reaction.reaction) 
#core_model.add_reactions([reaction])
##
