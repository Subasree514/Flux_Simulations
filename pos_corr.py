...
max_no_df.columns=['reactions','maximum_rs','minimum_rs','formulas_rs']
#print(len(half_no_df))
#print(len(max_no_df))
max_no_df.join(half_no_df,lsuffix='reactions')
print(max_no_df)
positive_rxns=round(abs(max_no_df['maximum']-max_no_df['minimum'])/abs(half_no_df['maximum']-half_no_df['minimum']),2)
...
print(pos_rxns_df.columns)
pos_rxns_df.to_excel('/home/subasree/Desktop/Models_to_work/pos_results1.xlsx')

negative_rxns=positive_rxns
...
print(neg_rxns_df)
neg_rxns_df.to_excel('/home/subasree/Desktop/Models_to_work/neg_results1.xlsx')
